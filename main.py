...
async def review_outline(
    ...
    guided_units: List[int] = []
    guided_mode = False
    if workflow_type == "supervisory_review" and review_scope == "full_thesis":
        try:
            ...
            raise HTTPException(
                status_code=400,
                detail=(
                    "The thesis structure could not be read reliably. Use clear chapter headings "
...
async def create_review(
    ...
    payload = {
        ...
        "guided_current_index": 0,
        "original_review_scope": review_scope,
    }
    try:
