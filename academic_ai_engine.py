...
def _batch_prompt(
    ...
    packet = {
        ...
        "instruction": (
            ...
            "For each coverage unit, assess every target_paragraph_id or target table row individually, use context_paragraph_ids only to understand continuity, and return all target IDs in assessed_paragraph_ids. "
