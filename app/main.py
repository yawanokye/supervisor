    ...
    *,
    ...
    try:
        ...
        final_hash = stable_hash({
            "pipeline": "review-pipeline-v2.2.0-final-exact-cost-efficient",
        ...
        if final_checkpoint:
            ...
            analysis_hash = stable_hash({
                "pipeline": "document-analysis-v2.2.0-visible-revisions-exact-map",
                "payload_hash": payload_hash,
            })
            ...
            academic_hash = stable_hash({
                "pipeline": "academic-review-complete-v2.2.0-cost-efficient-canonical-ledger",
