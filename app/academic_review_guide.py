...
GUIDE_BY_SECTION: Dict[str, List[str]] = {
    ...
    "methods_chapter": [
        ...
        "Diagnostics and assumptions appropriate to each statistical model should be planned, justified, assigned thresholds and linked to remedies for violations.",
    ...
    "results_discussion_chapter": [
        ...
        "Diagnostics appropriate to the statistical model should be reported, interpreted against accepted criteria and used to justify the estimator or corrective procedure.",
