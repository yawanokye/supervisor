...
RULES: List[Dict[str, Any]] = [
    ...
    make_rule("D10.5","D","Data Preparation and Assumption Checks","Diagnostics appropriate to the stated statistical model are specified",
              ["data preparation","data analysis","model specification","diagnostic tests","model diagnostics"],
              ["diagnostic","assumption","residual","vif","heteroscedasticity","autocorrelation","stationarity","cointegration","model fit","robustness"],
              critical=True,applicability=["quantitative","mixed","sem","econometrics"]),
    make_rule("D10.6","D","Data Preparation and Assumption Checks","Decision thresholds and remedies for diagnostic violations are explained",
              ["data preparation","data analysis","diagnostic tests"],
              ["threshold","cut off","remedy","robust standard error","transformation","winsor","correction","alternative estimator"],
              applicability=["quantitative","mixed","sem","econometrics"]),
    ...
    make_rule("E6","E","Results and Discussion","Diagnostics appropriate to the statistical model are reported and interpreted",
              ["diagnostic tests","model diagnostics","results","data analysis"],
              ["diagnostic","normality","vif","multicollinearity","heteroscedasticity","autocorrelation","stationarity","cointegration","model fit","residual","robustness"],
              critical=True,applicability=["quantitative","mixed","sem","econometrics"]),
    make_rule("E7","E","Results and Discussion","Reported statistics and interpretations are internally consistent",
              ["results","findings","hypothesis testing","discussion"],
              ["coefficient","p-value","confidence interval","significant","effect","relationship","r squared"],
              critical=True,applicability=["quantitative","mixed","sem","econometrics"],manual_only=True),
    make_rule("E8","E","Results and Discussion","Sample sizes, totals, percentages, tables, figures and narrative statements reconcile",
              ["results","findings","descriptive statistics"],
              ["sample","total","percentage","table","figure","frequency"],
              critical=True,applicability=["quantitative","mixed","sem","econometrics"],manual_only=True),
    make_rule("E9","E","Results and Discussion","Model fit, explanatory power and effect magnitude are interpreted accurately without overstatement",
              ["results","hypothesis testing","discussion"],
              ["model fit","r squared","adjusted r squared","effect size","coefficient","confidence interval"],
              applicability=["quantitative","mixed","sem","econometrics"],manual_only=True),
